...
const Category = () => {
    ...
    return (
        <>
            <DropdownButton id="dropdown-item-button" title="קטגוריות" variant="outline-warning" style={{position:"absolute", top:"1vw", right:"2vw"}}> 
            ...
            {IsAdd &&
                <div style={{position:"absolute", top:"4vw", right:"2vw", zIndex:"3"}}>
